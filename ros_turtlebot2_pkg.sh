#!/bin/bash
#This code is belong to Damien Jade Duff
#Please check his source here: https://bitbucket.org/damienjadeduff/456_kinetic_turtlebot/src/b8eacebf174b?at=master
echo 
